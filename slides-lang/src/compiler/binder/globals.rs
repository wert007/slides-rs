...
use slides_rs_core::{
    BaseElementStyling, GridEntry, GridStyling, HorizontalAlignment, ImageStyling, LabelStyling,
    ObjectFit, SlideStyling, SlidesEnum, TextAlign, TextStyling, VerticalAlignment,
};
...
pub const MEMBERS: [MemberDeclarations; 12] = [
